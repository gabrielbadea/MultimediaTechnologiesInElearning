...
function validateFields() {
    var arrayToSort = document.getElementById('array').value;       // citim datele introduse de utilizator
    if(arrayToSort == "") {                                         // se verifica daca campul nu contine date
        alert('Campul nu contine date!');
        return;
    }

    var isValid = /^[0-9,]*$/.test(arrayToSort);                    // isValid indica daca sirul contine doar cifre si caracterul ,
    if(!isValid) {
